...
Then read the row for `agesdk.dev`. Or pull from
...
- **Action:** project scaffolded via `portfolio new bootstrap`; first deploy pending. After deploy: verify in GSC as `sc-domain:agesdk.dev` and submit the sitemap.
